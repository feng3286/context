...
const TerminalSettingsCard: React.FC = () => {
  ...
  const pickerLabel = fontFamily.trim()
    ? (selectedPreset?.label ?? t('settings:terminal.customFont', { font: fontFamily.trim() }))
    : t('settings:terminal.defaultLabel');
  ...
  return (
    <div className="flex flex-col gap-4">
              ...
              <PopoverContent align="start" className="w-[var(--anchor-width)] p-2">
                <div className="grid gap-2">
                  <Input
                    ...
                    placeholder={t('settings:terminal.searchPlaceholder')}
                    aria-label={t('settings:terminal.searchAriaLabel')}
                    className="h-8"
                  />
                  <div className="max-h-56 overflow-auto">
                    ...
                    {loadingFonts ? (
                      <div className="px-2 py-1.5 text-sm text-muted-foreground">
                        {t('settings:terminal.loadingFonts')}
                      </div>
                    ) : null}
      ...
      />
      <SettingRow
        title={t('settings:terminal.autoCopy')}
        description={t('settings:terminal.autoCopyDesc')}
        control={
          <Switch
