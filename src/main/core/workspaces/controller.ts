...
import { canRemoveProjectFromWorkspace } from './operations/canRemoveProjectFromWorkspace';
...
import {
  canRemoveProjectFromAllWorkspaces,
  removeProjectFromAllWorkspaces,
} from './operations/removeProjectFromAllWorkspaces';
